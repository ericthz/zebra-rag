...
const options = computed(() => {
  const opts: DropdownOption[] = [
    ...
    },
    {
      ...
      icon: SvgIconVNode({ icon: 'material-symbols:refresh-rounded', fontSize: 18 })
    },
    {
      key: 'closeLeft',
      label: $t('dropdown.closeLeft'),
      icon: SvgIconVNode({ icon: 'material-symbols:format-indent-decrease-rounded', fontSize: 18 })
    },
    {
      key: 'closeRight',
      label: $t('dropdown.closeRight'),
      icon: SvgIconVNode({ icon: 'material-symbols:format-indent-increase-rounded', fontSize: 18 })
    },
    {
      key: 'closeAll',
      label: $t('dropdown.closeAll'),
      icon: SvgIconVNode({ icon: 'material-symbols:minimize-rounded', fontSize: 18 })
    }
  ];
