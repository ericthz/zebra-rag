...
import { SimpleScrollbar } from '@zebra/materials';
import { transformColorWithOpacity } from '@zebra/color';
...
<template>
  ...
  <DefineMixMenuItem v-slot="{ label, icon, active, isMini }">
    <div
      class="mx-4px mb-6px flex-col-center cursor-pointer rounded-[10.67px] bg-transparent px-4px py-8px transition-300 hover:bg-[rgb(0,0,0,0.08)]"
      :class="{
