declare namespace NaiveUI {
  ...
  type TableColumnCheck = import('@zebra/hooks').TableColumnCheck;
  type TableDataWithIndex<T> = import('@zebra/hooks').TableDataWithIndex<T>;
  type FlatResponseData<T> = import('@zebra/axios').FlatResponseData<T>;
  ...
  type NaiveTableConfig<A extends TableApiFn> = Pick<
    import('@zebra/hooks').TableConfig<A, GetTableData<A>, TableColumn<TableDataWithIndex<GetTableData<A>>>>,
